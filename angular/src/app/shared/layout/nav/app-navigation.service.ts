...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('ImportExports', 'Pages.Editions', 'flaticon-list', '/app/admin/importexports'),
            new AppMenuItem('Vehicles', 'Pages.Administration.Vehicles', 'flaticon-truck', '/app/admin/vehicles'),
            new AppMenuItem('Products', 'Pages.Editions', 'flaticon2-supermarket', '/app/admin/products'),
