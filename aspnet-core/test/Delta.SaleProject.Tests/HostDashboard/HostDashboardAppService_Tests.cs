...
using Delta.SaleProject.MultiTenancy.HostDashboard;
...
namespace Delta.SaleProject.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SaleProjectDbContext context, SubscriptionPayment subscriptionPayment)
        {
