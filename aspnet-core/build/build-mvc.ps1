...
$webMvcFolder = Join-Path $slnFolder "src/Delta.SaleProject.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Delta.SaleProject.Web.Public"
...
dotnet restore Delta.SaleProject.Web.sln
