...
namespace Delta.SaleProject.Core.Base
{
    public abstract class SaleProjectQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SaleProjectQueryBase(string fieldName,
