...
using Delta.SaleProject.Web.Startup.ExternalLoginInfoProviders;
...
namespace Delta.SaleProject.Web.Startup
{
    ...
    public class SaleProjectWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SaleProjectWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SaleProjectWebHostModule).GetAssembly());
        }
