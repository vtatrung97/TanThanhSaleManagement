...
using Delta.SaleProject.Services.Navigation;
...
using Delta.SaleProject.Controls;
using Delta.SaleProject.Dto;
using Delta.SaleProject.Extensions;
using Delta.SaleProject.Localization;
using Delta.SaleProject.UI;
using Delta.SaleProject.UI.Assets;
using Delta.SaleProject.Views;
using DependencyResolver = Delta.SaleProject.Core.Dependency.DependencyResolver;
...
namespace Delta.SaleProject.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SaleProject";
