...
using Delta.SaleProject.DemoUiComponents.Dto;

namespace Delta.SaleProject.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SaleProjectAppServiceBase, IDemoUiComponentsAppService
    {
