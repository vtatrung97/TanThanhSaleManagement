...
using Delta.SaleProject.UiCustomization;
...
{
    public class SessionAppService : SaleProjectAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = SaleProjectConsts.Currency,
                        CurrencySign = SaleProjectConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = SaleProjectConsts.AllowTenantsToChangeEmailSettings,
