...
namespace Delta.SaleProject.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SaleProjectAppServiceBase, IDashboardCustomizationAppService
    {
