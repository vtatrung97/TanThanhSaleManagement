...
using Delta.SaleProject.Migrations.Seed;
using Delta.SaleProject.Migrations.Seed.Host;
...
namespace Delta.SaleProject.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SaleProjectAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SaleProjectDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SaleProjectConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SaleProjectConsts.ConnectionStringName}", constring);
        }
