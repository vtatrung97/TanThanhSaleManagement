...
using Abp.UI;
using Delta.SaleProject.Notifications.Dto;

namespace Delta.SaleProject.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : SaleProjectAppServiceBase, INotificationAppService
    {
