...
using Delta.SaleProject.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : SaleProjectAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Delta.SaleProject",
