...
using Delta.SaleProject.Auditing.Exporting;
using Delta.SaleProject.Authorization;
using Delta.SaleProject.Authorization.Users;
using Delta.SaleProject.Dto;
using Delta.SaleProject.EntityHistory;
using EntityHistoryHelper = Delta.SaleProject.EntityHistory.EntityHistoryHelper;

namespace Delta.SaleProject.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SaleProjectAppServiceBase, IAuditLogAppService
    {
