...
using Delta.SaleProject.Authentication.TwoFactor;
...
using Delta.SaleProject.Web.Authentication.JwtBearer;
using Delta.SaleProject.Web.Authentication.TwoFactor;
using Delta.SaleProject.Web.Models.TokenAuth;
...
namespace Delta.SaleProject.Web.Controllers
{
    ...
    public class TokenAuthController : SaleProjectControllerBase
    {
