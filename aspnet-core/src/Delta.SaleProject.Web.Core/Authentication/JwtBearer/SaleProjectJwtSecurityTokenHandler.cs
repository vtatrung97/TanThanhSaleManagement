...
namespace Delta.SaleProject.Web.Authentication.JwtBearer
{
    public class SaleProjectJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public SaleProjectJwtSecurityTokenHandler()
        {
