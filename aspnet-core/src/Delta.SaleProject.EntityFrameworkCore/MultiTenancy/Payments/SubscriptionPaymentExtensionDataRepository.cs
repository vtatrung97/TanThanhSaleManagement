...
using Delta.SaleProject.EntityFrameworkCore.Repositories;

namespace Delta.SaleProject.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : SaleProjectRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SaleProjectDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
