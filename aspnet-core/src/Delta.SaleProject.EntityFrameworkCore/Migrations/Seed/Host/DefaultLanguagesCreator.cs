...
namespace Delta.SaleProject.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = SaleProjectConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(SaleProjectDbContext context)
        {
            _context = context;
        }
