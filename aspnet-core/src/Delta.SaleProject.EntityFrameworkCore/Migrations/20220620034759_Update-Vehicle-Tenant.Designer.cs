...
namespace Delta.SaleProject.Migrations
{
    ...
    [Migration("20220620034759_Update-Vehicle-Tenant")]
    partial class UpdateVehicleTenant
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Delta.SaleProject.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Delta.SaleProject.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Delta.SaleProject.ExportStocks.ExportStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ImportExportStockId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ImportExportStockId");

                    b.HasIndex("ProductId");

                    b.ToTable("ExportStocks");
                });
            ...
            modelBuilder.Entity("Delta.SaleProject.ImportStocks.ImportExportStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ImportExportStocks");
                });

            modelBuilder.Entity("Delta.SaleProject.ImportStocks.ImportStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Delta.SaleProject.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Delta.SaleProject.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Delta.SaleProject.Vehicles.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Delta.SaleProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Delta.SaleProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Delta.SaleProject.ExportStocks.ExportStock", b =>
                {
                    b.HasOne("Delta.SaleProject.ImportStocks.ImportExportStock", "ImportExportStock")
                        .WithMany("ExportStocks")
                        .HasForeignKey("ImportExportStockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Delta.SaleProject.Products.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ImportExportStock");
            ...
            modelBuilder.Entity("Delta.SaleProject.ImportStocks.ImportExportStock", b =>
                {
                    b.HasOne("Delta.SaleProject.Employees.Employee", null)
                        .WithMany("ImportExportStocks")
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Delta.SaleProject.Vehicles.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("Delta.SaleProject.Employees.Employee", b =>
                {
                    b.Navigation("ImportExportStocks");
                });

            modelBuilder.Entity("Delta.SaleProject.ImportStocks.ImportExportStock", b =>
                {
                    b.Navigation("ExportStocks");

                    b.Navigation("ImportStocks");
                });
