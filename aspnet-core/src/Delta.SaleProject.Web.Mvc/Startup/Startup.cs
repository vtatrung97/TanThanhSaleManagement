...
using Delta.SaleProject.Identity;
using Delta.SaleProject.Schemas;
using Delta.SaleProject.Web.Chat.SignalR;
using Delta.SaleProject.Web.Common;
using Delta.SaleProject.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Delta.SaleProject.Web.IdentityServer;
using Delta.SaleProject.Web.Swagger;
using Stripe;
...
using Delta.SaleProject.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using SecurityStampValidatorCallback = Delta.SaleProject.Identity.SecurityStampValidatorCallback;
...
namespace Delta.SaleProject.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<SaleProjectWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "SaleProject API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Delta.SaleProject.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                var applicationXml = $"Delta.SaleProject.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Delta.SaleProject.Web.Core.xml";
