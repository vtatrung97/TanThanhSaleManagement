...
using Delta.SaleProject.Authentication.TwoFactor.Google;
...
using Delta.SaleProject.Authorization.Impersonation;
...
using Delta.SaleProject.Net.Sms;
using Delta.SaleProject.Notifications;
using Delta.SaleProject.Web.Models.Account;
using Delta.SaleProject.Security;
using Delta.SaleProject.Security.Recaptcha;
using Delta.SaleProject.Sessions;
using Delta.SaleProject.Url;
using Delta.SaleProject.Web.Authentication.External;
using Delta.SaleProject.Web.Security.Recaptcha;
using Delta.SaleProject.Web.Session;
using Delta.SaleProject.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;

namespace Delta.SaleProject.Web.Controllers
{
    public class AccountController : SaleProjectControllerBase
    {
