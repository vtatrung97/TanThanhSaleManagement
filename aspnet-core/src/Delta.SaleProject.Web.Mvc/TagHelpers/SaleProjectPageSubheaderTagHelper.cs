...
using Delta.SaleProject.UiCustomization.Dto;

namespace Delta.SaleProject.Web.TagHelpers
{
    ...
    public class SaleProjectPageSubheaderTagHelper : TagHelper
    {
        ...
        public SaleProjectPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
