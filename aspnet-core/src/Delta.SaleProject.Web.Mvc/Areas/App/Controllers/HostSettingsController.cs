...
using Delta.SaleProject.Configuration.Host;
using Delta.SaleProject.Editions;
using Delta.SaleProject.Timing;
using Delta.SaleProject.Timing.Dto;
using Delta.SaleProject.Web.Areas.App.Models.HostSettings;
...
namespace Delta.SaleProject.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : SaleProjectControllerBase
    {
