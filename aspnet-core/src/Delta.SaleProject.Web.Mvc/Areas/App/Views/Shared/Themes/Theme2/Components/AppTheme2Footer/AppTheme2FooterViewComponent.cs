...
namespace Delta.SaleProject.Web.Areas.App.Views.Shared.Themes.Theme2.Components.AppTheme2Footer
{
    public class AppTheme2FooterViewComponent : SaleProjectViewComponent
    {
