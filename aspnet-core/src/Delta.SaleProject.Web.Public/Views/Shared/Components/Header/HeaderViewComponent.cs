...
using Delta.SaleProject.Web.Public.Startup;
using Delta.SaleProject.Web.Session;

namespace Delta.SaleProject.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SaleProjectViewComponent
    {
