...
using Delta.SaleProject.Authorization.Ldap;
...
using Delta.SaleProject.DashboardCustomization.Definitions;
using Delta.SaleProject.Debugging;
using Delta.SaleProject.DynamicEntityProperties;
using Delta.SaleProject.Features;
using Delta.SaleProject.Friendships;
using Delta.SaleProject.Friendships.Cache;
using Delta.SaleProject.Localization;
using Delta.SaleProject.MultiTenancy;
using Delta.SaleProject.Net.Emailing;
using Delta.SaleProject.Notifications;
using Delta.SaleProject.WebHooks;
using Newtonsoft.Json;

namespace Delta.SaleProject
{
    [DependsOn(
        typeof(SaleProjectCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SaleProjectCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SaleProjectLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SaleProjectConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SaleProjectMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SaleProjectSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SaleProjectCoreModule).GetAssembly());
        }
