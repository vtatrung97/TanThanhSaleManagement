...
namespace Delta.SaleProject.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SaleProjectServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Delta.SaleProject", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
