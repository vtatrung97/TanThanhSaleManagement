...
namespace Delta.SaleProject.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var vehicles = administration.CreateChildPermission(AppPermissions.Pages_Administration_Vehicles, L("Vehicles"));
            vehicles.CreateChildPermission(AppPermissions.Pages_Administration_Vehicles_Create, L("CreateVehicle"));
            vehicles.CreateChildPermission(AppPermissions.Pages_Administration_Vehicles_Update, L("UpdateVehicle"));
            vehicles.CreateChildPermission(AppPermissions.Pages_Administration_Vehicles_Delete, L("DeleteVehicle"));
        }

        private static ILocalizableString L(string name)
        {
            return new LocalizableString(name, SaleProjectConsts.LocalizationSourceName);
        }
    }
}
