...
using Delta.SaleProject.MultiTenancy.Demo;
...
namespace Delta.SaleProject.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(SaleProjectConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(SaleProjectConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
