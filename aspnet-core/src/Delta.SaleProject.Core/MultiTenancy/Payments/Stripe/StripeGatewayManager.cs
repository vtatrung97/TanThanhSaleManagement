...
namespace Delta.SaleProject.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : SaleProjectServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "SaleProject";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + SaleProjectConsts.Currency;
        }
